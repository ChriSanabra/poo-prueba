...
public class BookManager {
     ...
     * Se crea un libro por defecto con el título, el autor, el isbn , disponibilidad, el año y el género
    */

    public BookManager(){
        this.books = new ArrayList<>();
        addBook("juego de tronos", "George R. R. Martin", "asdasd", true, 2008, "fantasia");
    }
    /**
